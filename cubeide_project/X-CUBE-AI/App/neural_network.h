...
/******************************************************************************/
#define AI_NEURAL_NETWORK_MODEL_NAME          "neural_network"
#define AI_NEURAL_NETWORK_ORIGIN_MODEL_NAME   "neural_network"

/******************************************************************************/
#define AI_NEURAL_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NEURAL_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NEURAL_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NEURAL_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_NEURAL_NETWORK_IN \
  ai_neural_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NEURAL_NETWORK_IN_SIZE { \
  AI_NEURAL_NETWORK_IN_1_SIZE, \
}
#define AI_NEURAL_NETWORK_IN_SIZE_BYTES { \
  AI_NEURAL_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_NEURAL_NETWORK_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NEURAL_NETWORK_IN_1_CHANNEL     (10)
#define AI_NEURAL_NETWORK_IN_1_SIZE        (10)
#define AI_NEURAL_NETWORK_IN_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_NEURAL_NETWORK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NEURAL_NETWORK_OUT \
  ai_neural_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NEURAL_NETWORK_OUT_SIZE { \
  AI_NEURAL_NETWORK_OUT_1_SIZE, \
}
#define AI_NEURAL_NETWORK_OUT_SIZE_BYTES { \
  AI_NEURAL_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_NEURAL_NETWORK_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NEURAL_NETWORK_OUT_1_CHANNEL     (5)
#define AI_NEURAL_NETWORK_OUT_1_SIZE        (5)
#define AI_NEURAL_NETWORK_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_NEURAL_NETWORK_N_NODES (10)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup neural_network
 ...
 * @ref ai_neural_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_neural_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_neural_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_neural_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NEURAL_NETWORK_*
 * defines into file @ref neural_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_neural_network_forward(
